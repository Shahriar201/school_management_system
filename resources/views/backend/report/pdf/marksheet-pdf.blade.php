                                ...
                                <div style="border:solid 2px; padding:7px;">
                                    <div class="row">
                                        <div style="float: right;" class="col-md-2 text-center">
                                            <img src="{{ url('public/upload/school_image.jpg') }}" style="width: 120px; height: 120px; float: right;" alt="">
                                        </div>
                                        <div class="col-md-2">
                                        ...
                                        <div class="col-md-4 text-center" style="float: left;">
                                            ...
                                            <h6><strong>Kaliakair, Gazipur</strong></h6>
                                                ...
                                                <tbody>
                                                    @foreach ($allGrades as $mark)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                {{ number_format((float)$mark->grade_point,2) }} - {{ ($mark->grade_point == 5)
                                                                ?(number_format((float)$mark->grade_point,2)):(number_format((float)$mark->grade_point+1,2) - (float)0.01) }}
                                                            </td>
                                                        </tr>
                                                    @endforeach
                                                </tbody>
