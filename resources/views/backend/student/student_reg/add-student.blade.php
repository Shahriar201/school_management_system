                            ...
                            <div class="card-header">
                                ...
                                <h3>
                                    ...
                                    <a class="btn btn-success float-right btn-sm"
                                        href="{{ route('students.registration.view') }}">
                                ...
                                <form method="post"
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" name="name" value="{{ @$editData['student']['name'] }}"
                                                class="form-control form-control-sm">
                                        </div>

                                        <div class="form-group col-md-4">
                                            <label>Father's Name <font style="color: red">*</font></label>
                                            <input type="text" name="fname" value="{{ @$editData['student']['fname'] }}"
                                                class="form-control form-control-sm">
                                        </div>

                                        <div class="form-group col-md-4">
                                            <label>Mother's Name <font style="color: red">*</font></label>
                                            <input type="text" name="mname" value="{{ @$editData['student']['mname'] }}"
                                                class="form-control form-control-sm">
                                        </div>

                                        <div class="form-group col-md-4">
                                            <label>Mobile Number <font style="color: red">*</font></label>
                                            <input type="text" name="mobile" value="{{ @$editData['student']['mobile'] }}"
                                                class="form-control form-control-sm">
                                        </div>
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <select name="gender" class="form-control form-control-sm">
                                                ...
                                                <option value="Male"
                                                    {{ @$editData['student']['gender'] == 'Male' ? 'selected' : '' }}>Male
                                                </option>
                                                <option value="Female"
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <select name="religion" class="form-control form-control-sm">
                                                ...
                                                <option value="Hindu"
                                                    ...
                                                    Hindu</option>
                                                <option value="Khristan"
                                                    {{ @$editData['student']['religion'] == 'Khristan' ? 'selected' : '' }}>
                                                    Khristan</option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="form-group col-md-4">
                                            <img id="showImage"
                                                src="{{ !empty($editData['student']['image']) ? url('public/upload/student_images/' . $editData['student']['image']) : url('public/upload/no_image.jpg') }}"
